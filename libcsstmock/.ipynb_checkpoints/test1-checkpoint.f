     ...
     &                   , larr, nd1, ngalmax, ngal)
        write(*,"(A22, 3i12)")'Output  dim:', nd1, nl1, ngal
        write(*,"(A22, 4i12)")'1st line in fortran:', larr(:, 1)
        write(*,"(A22, 4i12)")'2st line in fortran:', larr(:, 2)
        write(*,"(A22, 4i12)")'3st line in fortran:', larr(:, 3)
        write(*,"(A22, 4i12)")'last line in fortran:', larr(:, ngal)
