...
class upwht(object):
    ...
    def upweight_healpy(data, indx, nside): 
        ...
        hppix  = np.arange(12*nside*nside) 
        ...
        # print(np.sum(count1), np.sum(indx) ) 
        # print(np.sum(count2), len(indx))
        ...
        #for ipix, c2 in zip(uniq_ipix2, count2): 
        #    if hpwht1[ipix] ==0: print(ipix, c2, hpwht2[ipix], hpwht1[ipix]) 
